<%-- 
    Document   : header
    Created on : mar,22 2021, 8:53:11 AM
    Author     : Brittany
--%>

<link rel="shortcut icon" href="images/tutoring.ico"><!-- icon on website tab -->
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js">Please enable Java script</script>
